...
export const MEMBERS_DATA = [
    ...
    // === TRAINEE (Ungu / Indigo / Sky / Slate / Silver / Lime) ===
    { name: "virgi", team: "trainee", color: "#a78bfa" },
    { name: "auwia", team: "trainee", color: "#818cf8" },
    { name: "rily", team: "trainee", color: "#c084fc" },
    { name: "giaa", team: "trainee", color: "#e4e4e7" },
    { name: "maira", team: "trainee", color: "#93c5fd" },
    { name: "ekin", team: "trainee", color: "#a855f7" },
    { name: "jemima", team: "trainee", color: "#6366f1" },
    { name: "mikaela", team: "trainee", color: "#7dd3fc" },
    { name: "intan", team: "trainee", color: "#8b5cf6" },
    { name: "fera", team: "trainee", color: "#cbd5e1" },
    { name: "carissa", team: "trainee", color: "#4f46e5" },
    { name: "bella", team: "trainee", color: "#a3e635" },
    { name: "fahira", team: "trainee", color: "#c4b5fd" },
    { name: "rara", team: "trainee", color: "#60a5fa" },
    { name: "heidi", team: "trainee", color: "#a5f3fc" },
    { name: "maxine", team: "trainee", color: "#7c3aed" },
    { name: "jazzy", team: "trainee", color: "#84cc16" },
    { name: "ralyne", team: "trainee", color: "#94a3b8" },
    { name: "sona", team: "trainee", color: "#d8b4fe" },
];
...
MEMBERS_DATA.forEach((member) => {
    ...
    if (member.alias) {
        member.alias.forEach((a) => {
            MEMBER_COLOR_MAP[a.toLowerCase()] = member.color;
        });
    }
});
 ...
 * @param {string} streamerName - Nama member (contoh: "Freya", "Freya JKT48", "Kathrina")
...
export function getMemberColor(streamerName, fallbackIndex = 0) {
    ...
    // Bersihkan nama: lowercase, hapus "jkt48", spasi, karakter spesial
    const clean = String(streamerName)
        .toLowerCase()
        .replace(/jkt48/g, "")
        .replace(/[^a-z0-9]/g, "")
        .trim();
    ...
    // 2. Cocokkan parsial (misal nama di DB "Kathrina" vs "katrina")
